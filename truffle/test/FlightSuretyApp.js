...
contract("FlightSuretyApp", async accounts => {
    ...
    it("registerAirline should require sender is owner airline if num airlines < 5", async () => {
        const address = "0x27d546acb70271e951058728fa4bfd1a5c5fa29c";
        const name = "rainbow airlines 2.0";
    ...
    // TODO THIS SHOULD FAIL, CURRENTLY PASSES
    it("registerAirline should require sender is any airline if num airlines >= 5", async () => {
        ...
        await truffleAssert.passes(
            await instance.registerAirline(airline6.address, airline6.name, { from: airline6.address })
        );
    });
});
